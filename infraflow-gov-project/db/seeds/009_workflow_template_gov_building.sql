...
FROM (VALUES
 ...
 ('EXEC_FOUNDATION',     'Foundation and plinth',                            'MILESTONE',   'DEMO-JE',      NULL,          $j${}$j$, $j${"milestone_code":"M1","milestone_name":"Foundation and plinth","lifecycle_stage":"CONSTRUCTION","sla_days":45}$j$),
 ('EXEC_SUPERSTRUCTURE', 'Superstructure',                                   'MILESTONE',   'DEMO-JE',      NULL,          $j${}$j$, $j${"milestone_code":"M2","milestone_name":"Superstructure","lifecycle_stage":"CONSTRUCTION","sla_days":60}$j$),
 ('EXEC_FINISHING',      'Finishing and services',                           'MILESTONE',   'DEMO-JE',      NULL,          $j${}$j$, $j${"milestone_code":"M3","milestone_name":"Finishing and services","lifecycle_stage":"CONSTRUCTION","sla_days":45}$j$),
